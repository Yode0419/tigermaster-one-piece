...
| `/to-jira` | Turns a requirement or bug into a Jira ticket (tigermaster SCRUM) via Q&A and a confirmed preview; personal API token lives in the gitignored `.claude/skills/to-jira/.env` |
