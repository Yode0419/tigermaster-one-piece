...
| [x] | [StatusBar](components/status-bar.md) | `Device` | 無對應 Flutter widget（系統原生渲染，僅 Prototype 展示用） | — |
| [x] | [HomeIndicator](components/home-indicator.md) | `Device` | 無對應 Flutter widget（系統原生渲染，僅 Prototype 展示用） | — |
