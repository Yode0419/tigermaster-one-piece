...
- [x] ~~列出「可能用於教學／行銷素材」而應優先遷移到 393×852 的既有畫面／流程清單~~：2026-09-24 移交 [figma-ssot](../../in-progress/figma-ssot/figma-ssot-overview.md) 階段 3。該階段會把現行 App 畫面全部以 393×852 重畫進正式主檔，舊 375 畫面移入 Archive，不再需要另列優先遷移清單
